...
public class AttachedFilesAdapter extends RecyclerViewListAdapter<ChatFragment.FileType> {
    private Context context;
    OnItemCancelClick onItemCancelClick;

    public AttachedFilesAdapter(Context context, OnItemCancelClick onItemCancelClick) {
        super(context);
    ...
    @Override
    protected void bindView(final ChatFragment.FileType item, RecyclerviewViewHolder viewHolder) {
        if (item != null) {
