...
public class FindLawyerEntity {
    ...
    @Expose
    private ExperienceDetailEntity experienceDetail;
    @SerializedName("affilation_detail")
    @Expose
    private AffiliationDetailEntity affilationDetail;
    ...
    public ExperienceDetailEntity getExperienceDetail() {
        return experienceDetail;
    }

    public void setExperienceDetail(ExperienceDetailEntity experienceDetail) {
        this.experienceDetail = experienceDetail;
    }

    public AffiliationDetailEntity getAffilationDetail() {
        return affilationDetail;
    }

    public void setAffilationDetail(AffiliationDetailEntity affilationDetail) {
        this.affilationDetail = affilationDetail;
    }
    ...
    public void setLanguages(ArrayList<LanguageEntity> languages) {
