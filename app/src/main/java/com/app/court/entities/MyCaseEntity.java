...
public class MyCaseEntity {
    ...
    @SerializedName("lawyer_detail")
    @Expose
    private LawyerDetailEntity lawyerDetail;
    ...
    public LawyerDetailEntity getLawyerDetail() {
        return lawyerDetail;
    }

    public void setLawyerDetail(LawyerDetailEntity lawyerDetail) {
